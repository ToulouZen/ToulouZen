...
import { View, TouchableOpacity, Image, Platform, PermissionsAndroid, Linking, Alert } from 'react-native'
            ...
            try {
                const granted = await PermissionsAndroid.request(
                    PermissionsAndroid.PERMISSIONS.CALL_PHONE,
                    {
                        ...
                        message: 'Autorisez l\'application Tarn Habitat à accéder au téléphone de l\'appareil pour vous mettre en lien avec vos interlocteurs ?',
                        buttonPositive: 'Ok',
                        buttonNegative: 'Non',
